...
import com.demo.newsapp.databinding.FragmentSearchBinding
import com.demo.newsapp.ui.NewsActivity
import com.demo.newsapp.ui.NewsViewModel
import com.demo.newsapp.util.Constants
import com.demo.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate =
                isNoErrors && isNotLoadingAndNoteLastPage && isAtLastItem && isNotAtBeginning && isTotalMoreThenVisible && isScrolling
            if (shouldPaginate) {
                newsViewModel.searchNews(binding.searchEdit.text.toString())
                isScrolling = false
            }
